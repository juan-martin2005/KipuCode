...
class FirebaseRemoteDataSource(
    ...
    suspend fun registerUserWithEmail(email: String, password: String) = firebaseAuth.createUserWithEmailAndPassword(email,password)
    suspend fun logoutUser() = firebaseAuth.signOut()
