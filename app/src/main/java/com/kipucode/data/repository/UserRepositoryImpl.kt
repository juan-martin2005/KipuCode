    ...
    override suspend fun refreshUserProfile(): Response<Unit> {
        return try {
            ...
            if (remoteProfile != null) {
                ...
                Response.Error("User profile not found in Firestore", ServerErrorType.FIRESTORE_ERROR)
            }
        } catch (e: Exception) {
            Response.Error("Failed to sync with network", ServerErrorType.FIRESTORE_ERROR)
        }
    }
}